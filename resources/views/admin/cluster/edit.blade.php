...
<div class="container-fluid">
    <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
        <div class="flex-grow-1">
            <h4 class="fs-18 fw-semibold m-0">Edit Cluster</h4>
            <p class="text-muted fs-14 mb-0">Edit data cluster SPKLU</p>
        </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <small class="form-text text-muted">
                                        Edit nama cluster yang akan digunakan untuk mengelompokkan SPKLU
                                    </small>
                                </div>
                            </div>
                        </div>
