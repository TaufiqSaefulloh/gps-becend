...
<div class="container-fluid">
    <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
        <div class="flex-grow-1">
            <h4 class="fs-18 fw-semibold m-0">Tambah UID</h4>
            <p class="text-muted fs-14 mb-0">Tambah UID baru</p>
        </div>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.uid.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <small class="form-text text-muted">
                                        Masukkan nama UID yang akan digunakan
                                    </small>
                                </div>
                            </div>
                            <div class="col-md-6">
